...
pyinstaller --noconfirm --onefile --name Workbench --add-data "static;static" --add-data ".workbench;.workbench" --add-data "docs;docs" --collect-all winpty --icon icon.ico --windowed desktop.py
$pyExit = $LASTEXITCODE

/* 线性图标集 (Lucide, MIT)。svgIcon(name, size) -> SVG 字符串 */
const ICON_PATHS = {
  ...
  fileText: '<path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><path d="M14 2v6h6"/><path d="M9.5 13h5M9.5 17h5M9.5 9h1"/>',
  fileCode: '<path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><path d="M14 2v6h6"/><path d="m10 13-2 2 2 2M14 13l2 2-2 2"/>',
  image: '<rect width="18" height="18" x="3" y="3" rx="2"/><circle cx="9" cy="9" r="2"/><path d="m21 15-3.1-3.1a2 2 0 0 0-2.8 0L6 21"/>',
  markdown: '<rect width="20" height="16" x="2" y="4" rx="2"/><path d="M6 15V9l3 3 3-3v6M17 9v4M15.5 11.5 17 13l1.5-1.5"/>',
  ...
  listChecks: '<path d="m3 7 2 2 4-4"/><path d="M12 7h9"/><path d="m3 17 2 2 4-4"/><path d="M12 17h9"/>',
  download: '<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4M7 10l5 5 5-5M12 15V3"/>',
  printer: '<path d="M6 9V2h12v7M6 18H4a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2h-2"/><rect width="12" height="8" x="6" y="14"/>',
  ...
  command: '<path d="M15 6a3 3 0 1 0 3 3H6a3 3 0 1 0 3-3v12a3 3 0 1 0 3-3H6a3 3 0 1 0-3 3"/>',
  ...
  sidebarRight: '<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M15 3v18"/>',
...
function svgIcon(name, size = 16) {
  ...
  return `<svg class="icn" width="${size}" height="${size}" viewBox="0 0 24 24" `
